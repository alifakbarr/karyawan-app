  ...
  <table class="table">
    ...
    <tbody class="text-center">
      <tr>
        ...
        <th class=""><a href="{{ route('handleKaryawan.showTaskProses',$karyawanId->user_id) }}" class="btn btn-sm btn-warning">Daftar Proses</a></th>
      </tr>
      <tr >
        <th scope="row" class="bg-secondary text-white">Verifikasi</th>
        <th>{{ $user_task_check->count() }}</th>
        <th class=""><a href="{{ route('handleKaryawan.showTaskCheck',$karyawanId->user_id) }}" class="btn btn-sm btn-secondary">Daftar Check</a></th>
      </tr>
      <tr>
        <th scope="row" class="bg-danger text-white">Revisi</th>
        <th>{{ $user_task_revisi->count() }}</th>
        <th class=""><a href="{{ route('handleKaryawan.showTaskRevisi',$karyawanId->user_id) }}" class="btn btn-sm btn-danger">Daftar Revisi</a></th>

      </tr>
      <tr >
        <th scope="row" class="bg-success text-white">Selesai</th>
        <th>{{ $user_task_selesai->count() }}</th>
        <th class=""><a href="{{ route('handleKaryawan.showTaskSelesai',$karyawanId->user_id) }}" class="btn btn-sm btn-success">Daftar Selesai</a></th>
